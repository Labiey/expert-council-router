...
The current release (0.6.1) includes:
...
```bash
codex plugin marketplace add Labiey/expert-council-router --ref v0.6.1 --json
...
& $ecCodex plugin marketplace add Labiey/expert-council-router --ref v0.6.1 --json
