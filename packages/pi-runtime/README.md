...
The current version (0.7.8) includes:
...
```bash
codex plugin marketplace add Labiey/expert-council-router --ref v0.7.8 --json
...
& $ecCodex plugin marketplace add Labiey/expert-council-router --ref v0.7.8 --json
