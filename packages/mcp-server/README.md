...
The current release (0.7.2) includes:
...
```bash
codex plugin marketplace add Labiey/expert-council-router --ref v0.7.2 --json
...
& $ecCodex plugin marketplace add Labiey/expert-council-router --ref v0.7.2 --json
