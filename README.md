...
The current release (0.7.5) includes:
...
```bash
codex plugin marketplace add Labiey/expert-council-router --ref v0.7.5 --json
...
& $ecCodex plugin marketplace add Labiey/expert-council-router --ref v0.7.5 --json
