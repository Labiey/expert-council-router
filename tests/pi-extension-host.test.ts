    ...
    try {
      ...
      const result = await delegate!.execute("call", {
        assignments: JSON.stringify([
          { role: "scout", task: "map files", taskDescription: "map", reasoningLevel: "low", timeoutMs: 60_000 },
          { role: "reviewer", task: "review map", taskDescription: "review", reasoningLevel: "medium", timeoutMs: 60_000 },
        ]),
      }, undefined, undefined);
