...
1. Ensure the working tree contains no `.env`, personal config, `.expert-council/telemetry.jsonl`, `.expert-council/state.json`, Pi settings, credentials, or generated worktrees.
